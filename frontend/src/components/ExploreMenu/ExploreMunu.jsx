...
const ExploreMunu = ({category,setCategory}) => {
  return (
    <div className='explore-menu' id='explore-menu'>
        ...
        <p className='explore-munu-text'>Choose from a diverse selection of sports venues, each offering unique features and top-quality amenities. Our mission is to cater to your sporting needs and provide an exceptional experience.</p>
